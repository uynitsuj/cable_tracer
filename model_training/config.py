...
class TRCR32_CL3_12_UNet34_B64_OS_MedleyFix_MoreReal_Sharp(BaseConfig):
    ...
    batch_size: int = 64
    # changed by m temporarily for training: while '../data/sim_data/trace_dataset_hard_2' is incorrect (U/O data instead of crossing)
    ...
    dataset_dir: List[str] = field(default_factory=lambda: [ '../data/sim_data/annotations_hard_knots_3', '../data/sim_data/trace_dataset_hard_adjacent_1', '../data/real_data/real_data_for_tracer'])
    dataset_weights: List[float] = field(default_factory=lambda: [0.2, 0.5, 0.3])
